// Lucide icon subset. ISC/MIT notices are in THIRD_PARTY_NOTICES.md.
const icons = {
  ...
  Eraser: '<path d="M21 21H8a2 2 0 0 1-1.42-.587l-3.994-3.999a2 2 0 0 1 0-2.828l10-10a2 2 0 0 1 2.829 0l5.999 6a2 2 0 0 1 0 2.828L12.834 21M5.082 11.09l8.828 8.828"/>',
  SlidersHorizontal: '<path d="M10 5H3M12 19H3M14 3v4M16 17v4M21 12h-9M21 19h-5M21 5h-7M8 10v4M8 12H3"/>',
...
export const uiIcon = (name) => `<svg class="ui-icon" viewBox="0 0 24 24" aria-hidden="true">${icons[name] || ""}</svg>`;
